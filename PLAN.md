...
La 3D tourne dès l'étape 3 avec des placeholders. Cette étape les remplace, un fichier à la fois, sans jamais toucher au code. `doc/11-assets-spec.md` fait foi.
