...
External PNGs are shared by all LODs via relative image URIs. The roughness PNG packs G = roughness and B = metalness for standard glTF PBR; the separate metal PNG remains editable. No PNG copies are embedded in the GLB.
