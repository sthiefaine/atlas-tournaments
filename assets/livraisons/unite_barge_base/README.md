...
Préparation : `python3 scripts/barge/preparer-source.py`, puis `python3 scripts/barge/finaliser.py` (Pillow). La source originale reste nécessaire localement. Aucun rendu ni décimation. Les normales sont stockées en float32 pour un alignement valide dans WebGPU.
...
- LOD0 unique : 934 594 triangles, dont les 934 558 triangles source et 36 pour les panneaux d’équipe. Poids exact du GLB dans `mesures.json`. LOD1 et LOD2 retirés.
