...
- LOD1 : 402 triangles, dont 72 brins et quatre trèfles.
...
Dans Premier contact, le moteur extrait `mat_herbe`, projette chaque sommet sur le terrain continu et regroupe les cases de plaine dans une géométrie. Il emploie le LOD0 tant que la végétation détaillée reste sous 200 000 triangles (106 cases de plaine avec cette livraison) ; au-delà, le LOD1. La couche reçoit l’éclairage, les ombres, les saisons et le brouillard. Elle est cachée en mode tactique. Les anciens bouquets procéduraux sont masqués lorsqu’elle est disponible.
