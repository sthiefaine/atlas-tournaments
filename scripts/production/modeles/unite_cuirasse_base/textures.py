...
PALETTE = [
    (167,167,167), # coque haute et tourelle couleur d'équipe, gris strict
    (57,64,67),    # coque immergée graphite peint
    (36,39,40),    # caoutchouc
    (141,148,153), # acier naval brossé
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(91091 + role)
