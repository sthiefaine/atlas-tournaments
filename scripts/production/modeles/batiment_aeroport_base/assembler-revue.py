...
ID='batiment_aeroport_base';OUT=Path('tmp/production-sequentielle')/ID;SOURCE=Path('scripts/production/modeles')/ID
...
active=Path('public/assets/modeles')/f'{ID}_lod0.glb';candidat=Path('assets/livraisons')/ID/f'{ID}_lod0.glb';old='51e17c267aef8476c47737348c6235a63e431a9915d46e5b977a6c92220fd2ca';assert sha(active)==sha(candidat)==old
...
runtime=[Path(x) for x in ['src/render3d/batiments-partages.ts','src/render3d/decor.ts','src/render3d/animations.ts']]
