...
PALETTE = [
    (182,182,182), # pont et nez couleur d'équipe, gris strict
    (54,63,67),    # coques étanches en composite graphite
    (36,39,40),    # caoutchouc
    (149,156,160), # aluminium/inox brossé
    (23,53,65),    # lentille teintée sans reflet peint
    (121,130,135), # panneaux gris techniques
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(182741 + role)
