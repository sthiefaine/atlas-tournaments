...
ID='batiment_usine_base';OUT=Path('tmp/production-sequentielle')/ID;SOURCE=Path('scripts/production/modeles')/ID
...
active=Path('public/assets/modeles')/f'{ID}_lod0.glb';candidat=Path('assets/livraisons')/ID/f'{ID}_lod0.glb';old='e0ef8956fdd8eb1fb1d45c7dd2ba422ad793536e147ed66be0f030c192a7ee9c';assert sha(active)==sha(candidat)==old
