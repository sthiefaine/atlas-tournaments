...
PALETTE = [
    (167,167,167), # flancs de nacelle et dérive couleur d'équipe, gris strict
    (57,64,67),    # sous-châssis graphite peint
    (36,39,40),    # caoutchouc
    (141,148,153), # aluminium/titane brossé
    (22,56,65),    # lentille teintée sans reflet peint
    (112,121,125), # panneaux gris techniques
    ...
    (22,56,65), (96,104,107), (49,56,59), (216,155,71),
]
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(90071 + role)
