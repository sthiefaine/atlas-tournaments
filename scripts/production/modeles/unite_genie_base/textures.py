...
PALETTE = [
    (188,188,188), # peinture neutre : casque, scanner, liseré
    (57,63,66),    # tissu technique pantalon et harnais
    (37,39,41),    # semelles, gants et caoutchouc
    (149,156,160), # métal nu
    (21,53,62),    # verre du terminal, sans reflet peint
    (140,146,144), # céramique du scanner et de la parabole
    (48,54,58),    # composite de réserve
    (211,155,70),  # témoin ambre escamotable
    (150,103,73),  # peau du technicien
    (198,148,116), # peau de la technicienne
    (68,44,29),    # cheveux bruns
    (28,26,24),    # cheveux sombres et yeux
    (127,112,85),  # toile renforcée des poches
    (177,177,177), # tissu d'équipe gris neutre
    (96,102,105),  # tissu neutre de réserve
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(462913 + role)
