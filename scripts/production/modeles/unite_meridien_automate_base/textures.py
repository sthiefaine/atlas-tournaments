...
IDENTIFIANT = 'unite_meridien_automate_base'
PALETTE = [
    (160,160,160), # panneaux couleur d'équipe, gris strict
    (59,65,69),    # tôle graphite peinte
    (36,39,40),    # caoutchouc
    (141,148,153), # aluminium/titane brossé
    (22,56,65),    # lentille teintée sans reflet peint
    (96,104,107),  # carénage technique gris
    (49,56,59),    # grille de refroidissement
    (216,155,71),  # verre ambré du témoin (pas une couleur de camp)
    (160,160,160), (59,65,69), (36,39,40), (141,148,153),
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(41592 + role)
