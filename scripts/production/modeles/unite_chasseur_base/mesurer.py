...
identifiant='unite_chasseur_base'
...
assert rapport['noeuds']==['base','corps','racine','socle'] and len(doc['materials'])==1
assert rapport['materiaux']==['mat_corps'] and rapport['interpolationClips']==['LINEAR']
