...
PALETTE = [
    ...
    (62,69,72),    # peinture technique graphite des équipements
    (53,53,49),    # caoutchouc légèrement poussiéreux
    (149,156,160), # aluminium/inox brossé
    (23,53,65),    # lentille teintée sans reflet peint
    (152,160,161), # panneaux neutres de la capsule
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(920527 + role)
        ...
        if genre == 8:
            # Nervures pressées : relief de matière, jamais une ombre.
