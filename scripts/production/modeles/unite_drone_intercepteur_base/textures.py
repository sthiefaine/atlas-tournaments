...
PALETTE = [
    (174,174,174), # nez, capsule et ailes couleur d'équipe, gris strict
    (50,60,65),    # sous-châssis graphite peint
    (36,39,40),    # caoutchouc
    (149,156,160), # aluminium/titane brossé
...
def fabriquer(sortie: Path):
    ...
    for role in range(16):
        rng = np.random.default_rng(147293 + role)
