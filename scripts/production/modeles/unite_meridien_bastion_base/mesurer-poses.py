...
borne_temoin=decalage_horizontal+norme_max_translation(noeuds['module_tourelle'])+norme_max_translation(noeuds['socle'])+float(np.linalg.norm(points[noeuds['socle']],axis=1).max())
