...
# Atlas 4x4, rôles stables : béton ; béton réservé ; équipe ; métal ; vitrage ; tôle ; câble ; caoutchouc ; porte ; réserve ; feu.
palette=[(181,183,179),(181,183,179),(167,167,167),(143,153,157),(29,68,81),(194,199,197),(58,63,65),(36,39,39),(134,149,152),(181,183,179),(238,191,113),(29,68,81),(181,183,179),(181,183,179),(181,183,179),(181,183,179)]
...
for role in range(16):
 rng=np.random.default_rng(295401+role);v,u=np.mgrid[0:S,0:S]/S
