...
# Atlas 4x4, rôles stables : béton ; réflecteur peint ; équipe ; métal ; vitrage ; tôle ; câble ; caoutchouc ; porte ; réserve ; feu.
palette=[(181,183,179),(203,208,205),(167,167,167),(143,153,157),(29,68,81),(193,198,196),(58,63,65),(36,39,39),(134,149,152),(181,183,179),(238,191,113),(29,68,81),(181,183,179),(181,183,179),(181,183,179),(181,183,179)]
rough=[224,145,166,113,47,182,193,228,181,224,57,51,224,224,224,224]
...
for role in range(16):
 rng=np.random.default_rng(305401+role);v,u=np.mgrid[0:S,0:S]/S
