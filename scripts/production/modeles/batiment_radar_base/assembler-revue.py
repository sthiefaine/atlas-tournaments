...
ID='batiment_radar_base';OUT=Path('tmp/production-sequentielle')/ID;SOURCE=Path('scripts/production/modeles')/ID
...
active=Path('public/assets/modeles')/f'{ID}_lod0.glb';candidat=Path('assets/livraisons')/ID/f'{ID}_lod0.glb';old='cf3e5f30e142acbdc4019c1cc30d1317dff872ef25919e7ac571ed34607cf8c5';assert sha(active)==sha(candidat)==old
