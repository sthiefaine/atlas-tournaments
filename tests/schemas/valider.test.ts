...
const suites: Suite[] = [
  ...
  },
  {
    ...
    invalides: [
      ...
      { titre: 'arme secondaire sur une unité sans munitions', muter: (o) => { o['munitions'] = null; o['armeSecondaire'] = ['infanterie']; }, chemin: 'armeSecondaire' },
      { titre: 'arme secondaire sur une cible à 0 dans la ligne', muter: (o) => { o['armeSecondaire'] = ['helico']; }, chemin: 'armeSecondaire' },
      { titre: 'arme secondaire qui couvre toute la ligne', muter: (o) => { o['armeSecondaire'] = Object.keys(o['degats'] as object); }, chemin: 'armeSecondaire' },
      { titre: 'tir à sec sans arme secondaire déclarée', muter: (o) => { o['degatsSecondaire'] = 15; }, chemin: 'degatsSecondaire' },
      { titre: 'tir à sec hors bornes', muter: (o) => { o['armeSecondaire'] = ['infanterie']; o['degatsSecondaire'] = 40; }, chemin: 'degatsSecondaire' },
  ...
  },
  {
    ...
    valide: sauvegarde,
    invalides: [
      { titre: 'version de catalogue négative', muter: (o) => { o['catalogueVersion'] = -1; }, chemin: 'catalogueVersion' },
