...
| [10-rendu-3d.md](10-rendu-3d.md) | La 3D three.js : caméra, terrain et splat map, éclairage par saison, phase et météo, unités et masque d'équipe, surbrillances, performance, HUD HTML, interface `Rendu` commune aux deux peaux | le rendu 3D |
