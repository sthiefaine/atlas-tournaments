...
- **calibration `auto`** : `msCalibration`, la médiane des dix images qui suivent la première, processeur graphique compris (`readPixels`), lue au chargement en qualité `auto` avant tout autre réglage ; c'est le chiffre que le seuil de 8 ms du §9.3 compare.
