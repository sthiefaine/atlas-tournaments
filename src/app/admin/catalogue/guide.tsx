...
export function GuideCatalogue() {
  const catalogue = chargerCatalogue(7);
  return <section aria-label="Rôles et contre-unités" className="space-y-3 mb-6"><h2 className="admin-titre">Quand produire chaque unité ?</h2><p>28 rôles à éprouver sur le terrain. Les dégâts ci-dessous sont les valeurs de base ; portée, abris, points de vie et initiative changent le duel réel.</p>{catalogue.cles.map(cle => {
