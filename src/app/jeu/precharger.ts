...
/**
 * Réchauffe le module de la toile — moteur de règles, IA, peau du jeu
 * (`render2d/`) — **avant** que le joueur ne clique.
 *
 ...
 * qu'il lui faut le module de la toile. Mesuré le 8 septembre 2026, du temps
 * du moteur WebGPU (330 ko), sur le serveur de développement, cache froid :
 * 4,2 s entre la première image de la page et l'arrivée des modules. La peau
 * 2D pèse moins que ce moteur, mais le module reste à télécharger ; l'écran de
 * chargement couvre l'attente, et la couvrir n'est pas la supprimer.
 *
 ...
 * rendre côté serveur sans jamais évaluer la peau.
 *
 * Deux garde-fous : on ne le fait qu'une fois, et jamais quand l'appareil a
 * demandé d'économiser les données — dépenser des centaines de kilo-octets pour
 * une page qu'on survole sans la choisir serait une impolitesse.
 */
